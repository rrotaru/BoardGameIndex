    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            while (resultSet.next()) {
                out.println(resultSet.getString("id")+": "+resultSet.getString("name")+" "+resultSet.getString("minPlayers")+resultSet.getString("maxPlayers")+": "+resultSet.getString("publisher")+"<br/>");
            }
            resultSet.close();
            statement.close();
            connection.close();
